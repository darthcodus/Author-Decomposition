...
def main():
    ...
    clusterMajorityAuthorIndices, clusterPurities, overallPurity = ce.evaluatePurity(clusters, text)
    ...
    with open(args.outputfile, "w") as fout:
        ...
        fout.write( "Overall purity: {0}\n".format(str(overallPurity)) )
        print("Overall purity: ", overallPurity)
